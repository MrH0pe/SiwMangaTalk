...
1)	Operazione di inserimento dati di una entità: L’utente registrato può scrivere zero o molti commenti .
2)	Operazione di aggiornamento dati di una entità: Aggiornamento di uno o molti commenti, scritti dagli utenti.
3)	Operazione di cancellazione di una entità: L’utente può cancellare soltanto i propri commenti scritti nei vari Thread. Mentre l’admin può cancellare qualsiasi commento di qualsiasi utente.
4)	Operazione di lettura dati di una entità o più entità:  Una pagina web che contiene tutti i commenti scritti da un singolo utente in molti Thread.
